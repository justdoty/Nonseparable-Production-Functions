...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Investment/Plots/Hicks/HICKS_K_AQME.png", hkaqme_plot)
#Hicks-Labor
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Investment/Plots/Hicks/HICKS_L_AQME.png", hlaqme_plot)
#Hicks-Materials
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Investment/Plots/Hicks/HICKS_M_AQME.png", hmaqme_plot)
#Hicks-Productivity
hwpost <- c(2,12:20)
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Investment/Plots/Hicks/HICKS_W_AQME.png", hwaqme_plot)
######################################################################################################################################################################################
#Productivity
#####################################################################################################################################################################################
...
acon <- c(t(adata[,2:T]))
omgx <- sweep(WX(A=acon, omega=omglag)[,-c(dims$W)], 2, c(1:3), "*")
