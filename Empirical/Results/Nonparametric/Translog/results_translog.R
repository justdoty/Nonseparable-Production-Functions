...
source('/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Results/Nonparametric/Tensors.R')
...
########################################################################################################
set.seed(123456)
load("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Results/Nonparametric/Translog/US_Nonparametric_trans.RData")
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Results/Nonparametric/Translog/Plots/Diagnostics/K_EM.png", K_EM) 
#Labor
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Results/Nonparametric/Translog/Plots/Diagnostics/L_EM.png", L_EM) 
#Materials
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Results/Nonparametric/Translog/Plots/Diagnostics/M_EM.png", M_EM) 
###############################################################################
...
##################################################
#Capital
kpost <- c(4,7,9,10,13,16,18,19)
kdat <- cbind(1, laby, maty, 2*capy, omgy, omgy*laby, omgy*maty, 2*capy*omgy)
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Results/Nonparametric/Translog/Plots/Elasticities/K_AQME.png", kaqme_plot)
#Labor
lpost <- c(5,7,8,11,14,16,17,20)
ldat <- cbind(1, capy, maty, 2*laby, omgy, omgy*capy, omgy*maty, 2*laby*omgy)
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Results/Nonparametric/Translog/Plots/Elasticities/L_AQME.png", laqme_plot)
#Materials
mpost <- c(6,8,9,12,15,17,18,21)
mdat <- cbind(1, laby, capy, 2*maty, omgy, omgy*laby, omgy*capy, 2*maty*omgy)
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Results/Nonparametric/Translog/Plots/Elasticities/M_AQME.png", maqme_plot)
#Hicks-Capital
hkpost <- c(13,16,18,19)
hkdat <- cbind(1, laby, maty, 2*capy)
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Results/Nonparametric/Translog/Plots/Hicks/HICKS_K_AQME.png", hkaqme_plot)
#Hicks-Labor
hlpost <- c(14,16,17,20)
hldat <- cbind(1, capy, maty, 2*laby)
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Results/Nonparametric/Translog/Plots/Hicks/HICKS_L_AQME.png", hlaqme_plot)
#Hicks-Materials
hmpost <- c(15,17,18,21)
hmdat <- cbind(1, laby, capy, 2*maty)
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Results/Nonparametric/Translog/Plots/Hicks/HICKS_M_AQME.png", hmaqme_plot)
#Hicks-Productivity
hwpost <- c(2,13:21)
hwdat <- cbind(1, capy, laby, maty, capy*laby, laby*maty, capy*maty, capy^2, laby^2, maty^2)
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Results/Nonparametric/Translog/Plots/Hicks/HICKS_W_AQME.png", hwaqme_plot)
######################################################################################################################################################################################
#Productivity
#####################################################################################################################################################################################
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Results/Nonparametric/Translog/Plots/TFP/OMG_AQME.png", omgaqme_plot)
################
##Density Plots
###############
omgdat <- data.frame(omg)
omgdens_plot <- ggplot(omgdat, aes(x=omg)) + geom_density() + xlab("Productivity") + ylab("")
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Results/Nonparametric/Translog/Plots/TFP/OMG_DENS.png", omgdens_plot)
# #######################
# #Surface Plots
# #####################
# #Commands for Colors
