...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Capital/Plots/Elasticities/KLMAQME.png", klmaqme, base_height =5, base_width = 15)
#Hicks-Capital
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Capital/Plots/Elasticities/HKLMAQME.png", hklmaqme, base_height =5, base_width = 15)
#Hicks-Productivity
hwpost <- c(2,12:20)+1
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Capital/Plots/Elasticities/KLMIQME.png", klm3dplots, base_height =5, base_width = 15)
#Hicks-Capital###########################################################################################
hk3d <- function(x){
...
save_plot("/Users/justindoty/Documents/Research/Dissertation/Nonlinear_Production_Function_QR/Code/Empirical/Capital/Plots/Elasticities/HKLMIQME.png", hklm3dplots, base_height =5, base_width = 15)
######################################################################################################################################################################################
#Productivity
#####################################################################################################################################################################################
