...
stdI <- sd(US$I)
#De-mean
US <- US %>% mutate(Y=Y-mean(Y), K=(K-mean(K))/stdK, L=(L-mean(L))/stdL, M=(M-mean(M))/stdM, I=(I-mean(I))/stdI)
wmin <- -5
wmax <- 5
#Capital
...
betaldata <- array(0, c(N, T, length(tauxi), length(tauinit)))
...
betamdata <- array(0, c(N, T, length(tauxi), length(tauinit)))
...
betakdata <- array(0, c(N, T, length(tauxi), length(tauinit)))
#This is for when i vary the shocks to investment demand
...
for (q1 in 1:length(tauinit)){
	...
	for (q2 in 1:length(tauxi)){
		...
		lnldata[,,,q2][,,q1][,1] <- l1
		lnmdata[,,,q2][,,q1][,1] <- m1
		yspline <- lspline(vectau=vectau, bvec=parY, b1=parYb[1], bL=parYb[2], u=eta[,1])
		#Elasticities
		betak <- rowSums(cbind(1, lnldata[,,,q2][,,q1][,1], lnmdata[,,,q2][,,q1][,1], 2*lnkdata[,,,q2][,,q1][,1], omgdata[,,,q2][,,q1][,1], omgdata[,,,q2][,,q1][,1]*lnldata[,,,q2][,,q1][,1], omgdata[,,,q2][,,q1][,1]*lnmdata[,,,q2][,,q1][,1], 2*lnkdata[,,,q2][,,q1][,1]*omgdata[,,,q2][,,q1][,1])*yspline[,kpost])
		#Restrict Supports
		betakdata[,,,q2][,,q1][,1] <- (betak>1)*1+(betak<1e-3)*1e-3+(betak<=1)*(betak>=1e-3)*betak
		betal <- rowSums(cbind(1, lnkdata[,,,q2][,,q1][,1], lnmdata[,,,q2][,,q1][,1], 2*lnldata[,,,q2][,,q1][,1], omgdata[,,,q2][,,q1][,1], omgdata[,,,q2][,,q1][,1]*lnkdata[,,,q2][,,q1][,1], omgdata[,,,q2][,,q1][,1]*lnmdata[,,,q2][,,q1][,1], 2*lnldata[,,,q2][,,q1][,1]*omgdata[,,,q2][,,q1][,1])*yspline[,lpost])
		#Restrict Supports
		betaldata[,,,q2][,,q1][,1] <- (betal>1)*1+(betal<1e-3)*1e-3+(betal<=1)*(betal>=1e-3)*betal
		betam <- rowSums(cbind(1, lnldata[,,,q2][,,q1][,1], lnkdata[,,,q2][,,q1][,1], 2*lnmdata[,,,q2][,,q1][,1], omgdata[,,,q2][,,q1][,1], omgdata[,,,q2][,,q1][,1]*lnldata[,,,q2][,,q1][,1], omgdata[,,,q2][,,q1][,1]*lnkdata[,,,q2][,,q1][,1], 2*lnmdata[,,,q2][,,q1][,1]*omgdata[,,,q2][,,q1][,1])*yspline[,mpost])
		#Restrict Supports
		betamdata[,,,q2][,,q1][,1] <- (betam>1)*1+(betam<1e-3)*1e-3+(betam<=1)*(betam>=1e-3)*betam
		#Output
		lnydata[,,,q2][,,q1][,1] <- y1
	...
	for (t in 2:T){
		...
		for (q2 in 1:length(tauxi)){
			...
			#Generate Output
			yspline <- lspline(vectau=vectau, bvec=parY, b1=parYb[1], bL=parYb[2], u=eta[,t])
			#Elasticities
			betak <- rowSums(cbind(1, lnldata[,,,q2][,,q1][,t], lnmdata[,,,q2][,,q1][,t], 2*lnkdata[,,,q2][,,q1][,t], omgdata[,,,q2][,,q1][,t], omgdata[,,,q2][,,q1][,t]*lnldata[,,,q2][,,q1][,t], omgdata[,,,q2][,,q1][,t]*lnmdata[,,,q2][,,q1][,t], 2*lnkdata[,,,q2][,,q1][,t]*omgdata[,,,q2][,,q1][,t])*yspline[,kpost])
			#Restrict Supports
			betakdata[,,,q2][,,q1][,t] <- (betak>1)*1+(betak<1e-3)*1e-3+(betak<=1)*(betak>=1e-3)*betak
			betal <- rowSums(cbind(1, lnkdata[,,,q2][,,q1][,t], lnmdata[,,,q2][,,q1][,t], 2*lnldata[,,,q2][,,q1][,t], omgdata[,,,q2][,,q1][,t], omgdata[,,,q2][,,q1][,t]*lnkdata[,,,q2][,,q1][,t], omgdata[,,,q2][,,q1][,t]*lnmdata[,,,q2][,,q1][,t], 2*lnldata[,,,q2][,,q1][,t]*omgdata[,,,q2][,,q1][,t])*yspline[,lpost])
			#Restrict Supports
			betaldata[,,,q2][,,q1][,t] <- (betal>1)*1+(betal<1e-3)*1e-3+(betal<=1)*(betal>=1e-3)*betal
			betam <- rowSums(cbind(1, lnldata[,,,q2][,,q1][,t], lnkdata[,,,q2][,,q1][,t], 2*lnmdata[,,,q2][,,q1][,t], omgdata[,,,q2][,,q1][,t], omgdata[,,,q2][,,q1][,t]*lnldata[,,,q2][,,q1][,t], omgdata[,,,q2][,,q1][,t]*lnkdata[,,,q2][,,q1][,t], 2*lnmdata[,,,q2][,,q1][,t]*omgdata[,,,q2][,,q1][,t])*yspline[,mpost])
			#Restrict Supports
			betamdata[,,,q2][,,q1][,t] <- (betam>1)*1+(betam<1e-3)*1e-3+(betam<=1)*(betam>=1e-3)*betam
			#Output
			lny <- rowSums(PF(K=lnkdata[,,,q2][,,q1][,t], L=lnldata[,,,q2][,,q1][,t], M=lnmdata[,,,q2][,,q1][,t], omega=omgdata[,,,q2][,,q1][,t])*yspline)
			#Restricting the Supports
...
write(Yjson, "/Users/justindoty/Documents/Home/My_Website/static/jmp/main/impulseY.json")
...
Misplot
Misjson <- plotly_json(Y, FALSE)
write(Misjson, "/Users/justindoty/Documents/Home/My_Website/static/jmp/main/impulseMis.json")
